...
namespace Gala.FrameworkEditorTools
{
    public class OpenLogAsset
    {
        ...
        static bool OnOpenAsset(int instanceID, int line)
        {
            ...
            if (!string.IsNullOrEmpty(stackTrace) && (stackTrace.Contains("UnityEngine.Log:Info") || stackTrace.Contains("UnityEngine.Log:RedInfo") || stackTrace.Contains("UnityEngine.Log:Error")))
            {
